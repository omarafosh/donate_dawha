<div id="modal-advertisment" class="modal">
    <!-- Modal content -->
...
<style>
    ...
    #modal-advertisment .close-modal {
        display: flex;
    ...
    #modal-advertisment .close-modal span {
    ...
    #modal-advertisment .data .header {
        color: #e00570;
    }

    #modal-advertisment .options {
        display: flex;
        justify-content: center;
        column-gap: 16px;
    }

    #modal-advertisment .options label {
        padding: 8px 15px;
    ...
    #modal-advertisment .data .description {
        text-align: center;
        font-size: 18px;
        font-weight: 700;
    }

    #modal-advertisment input {
        width: 75%;
        height: 40px;
        padding: 0px 10px;
        border-radius: 6px;
    ...
    #modal-advertisment .mony {
        color: #e00570;
        font-size: 20px;
        font-weight: 700;
    }

    #modal-advertisment .donate {
        font-family: "Cairo", sans-serif;
        border: none;
        font-size: 16px;
        color: #fff;
