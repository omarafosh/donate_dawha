<div id="modal-mosque" class="modal">
    <!-- Modal content -->
...
<style>
    ...
    #modal-mosque .data .header {
        color: #e00570;
    }

    #modal-mosque .options {
        display: flex;
        justify-content: center;
        column-gap: 16px;
    }

    #modal-mosque .options label {
        padding: 8px 15px;
